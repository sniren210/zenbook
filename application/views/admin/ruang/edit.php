  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form method="post" action="<?=  base_url('admin/ruangan/edit'.$row->id_ruang) ?>">              
      <div class="row">
        <div class="col-md-12">
          <div class="card ">
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="inputStatus">Jenis</label>
                 <select class="form-control custom-select" name="jenis">
                  <option <?php if ($row->jenis == 'Bengkel') {echo "selected";} ?> value="Bengkel">Bengkel</option>
                  <option <?php if ($row->jenis == 'Umum') {echo "selected";} ?> value="Umum">Umum</option>
                 </select>
              </div>
            </div>
            <!-- /.card-body -->
